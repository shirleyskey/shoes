...
<form method="post" class="form-inline" action="admin.php?page=upicrm_webservices">
    ...
    <div class="form-group">
        ...
        <input type="text" name="webservice_url" value="<?php if (isset($webservice_url)) echo $webservice_url; ?>" placeholder="http://" style="margin-right: 10px; height: 29px;" />
    </div>
    ...
    <div class="form-group" style="margin-right: 10px;">
        ...
        <input type="text" name="upicrm_ws_user_agent" value="<?php echo get_option('upicrm_ws_user_agent'); ?>" style="margin-right: 10px; height: 29px;" />
    </div>
    <br /><br />
    ...
    <?php for($i=1; $i<=3; $i++) { ?>
        ...
        <div class="form-group" style="margin-right: 10px;">
            ...
            <input type="text" name="webservice_header_key<?php echo $i; ?>" value="<?php echo $webs_OBJ->$var; ?>" placeholder="<?php _e('Key', 'upicrm'); ?>" style="margin-right: 10px; height: 29px;" />
            : &nbsp;
            <?php $var = "webservice_header_value".$i; ?>
            <input type="text" name="webservice_header_value<?php echo $i; ?>" value="<?php echo $webs_OBJ->$var; ?>"  placeholder="<?php _e('Value', 'upicrm'); ?>" style="margin-right: 10px; height: 29px;" />
        </div>
    <?php } ?>
